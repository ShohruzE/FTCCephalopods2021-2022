...
@Disabled
@Autonomous(name = "Autonomous_RedRight - Team_9385", group = "Autonomous - 9385")
public class Autonomous_9385_RedRight extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        encoderDrive(0.6, 33, -33, 33, -33); // Move backwards
        encoderDrive(0.6, -20, -20, -20, -20); // Rotate clockwise
        moveArm(1, 2000);                                                                   // Raise arm
        encoderDrive(0.4, -6,6,-6,6); // Approach hub
        intake(1, 2000);                                                            // Outtake pre-load freight
        encoderDrive(0.4, 6,-6,6,-6); // Move backwards away from hub
        moveArm(-1, 1500);                                                             // Lower arm
        encoderDrive(0.6, 20, 20, -20, -20); // Strafe left
        encoderDrive(1, 30, -30,30,-30);   // Move backwards and park
