...
@Disabled
@Autonomous(name = "Autonomous_BlueRight - Team_9384", group = "Autonomous - 9384")
public class Autonomous_9384_BlueRight extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        leftArmMotor    = hardwareMap.get(DcMotor.class, "LAM");
        rightArmMotor   = hardwareMap.get(DcMotor.class, "RAM");
